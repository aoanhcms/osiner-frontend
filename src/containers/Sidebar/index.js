...
const Sidebar = () => {
  ...
  let {app_bot_id} = useSelector(({app_bot}) => app_bot);
  ...
  if (navStyle === NAV_STYLE_HIDDEN) {
    //drawerStyle = "gx-hidden-sidebar";
      ...
      collapsible>
      {
        navStyle === NAV_STYLE_DRAWER || width < TAB_SIZE ?
          <Drawer
            ...
            <SidebarContent app_bot_id={app_bot_id} sidebarCollapsed={sidebarCollapsed} setSidebarCollapsed={setSidebarCollapsed}/>
          </Drawer> :
          <SidebarContent app_bot_id={app_bot_id} sidebarCollapsed={sidebarCollapsed} setSidebarCollapsed={setSidebarCollapsed}/>
      }
    </Sider>)
